...
function buildNotificationDetails(record: AgentRecord, resultMaxLen: number, _activity?: AgentActivity): NotificationDetails {
  let totalTokens = 0;
  try {
...
export default function (pi: ExtensionAPI) {
  ...
  // Collects background agent IDs spawned in the current request burst for smart grouping.
  ...
  // Grab UI context from first tool execution + clear lingering widget on new activity
